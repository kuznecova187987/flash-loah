...
describe("high gas agent", function () {
    var handleTransaction;
    var createTxEventWithGasUsed = function (gasUsed) { return forta_agent_1.createTransactionEvent({
        transaction: {},
    ...
    describe("handleTransaction", function () {
        it("returns empty findings if gas used is below threshold", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txEvent, findings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txEvent = createTxEventWithGasUsed("1");
        ...
        it("returns a finding if gas used is above threshold", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txEvent = createTxEventWithGasUsed("1000001");
                        return [4 /*yield*/, handleTransaction(txEvent)];
                    case 1:
                        findings = _a.sent();
                        expect(findings).toStrictEqual([
